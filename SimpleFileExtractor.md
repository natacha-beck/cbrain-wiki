...
For example, you have different CivetOutputs and you are interested in some of the thickness and surface files. To avoid having to download all the files, you can select those CivetOuputs files and launch the SimpleFileExtractor tool.
