...
For example, you have different CivetOutputs and you are interested in some of the thickness and surface files. You select those CivetOuputs files and launch the SimpleFileExtractor tool.
