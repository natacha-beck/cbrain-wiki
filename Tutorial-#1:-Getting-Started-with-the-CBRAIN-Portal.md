# Introduction
This tutorial is meant to give a new CBRAIN user a first experience in managing files and running a parallel task in the McGill hosted [CBRAIN Neuroscience Portal](https://cbrain.ca/).
